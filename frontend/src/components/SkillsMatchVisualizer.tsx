            ...
            {requiredSkills.map((skill, index) => {
              ...
              return (
                <div key={index} className="flex items-center">
                  ...
                  <span
                    className={`text-sm ${
                      isMatched ? "text-gray-800" : "text-red-700"
                    }`}
                  >
                    {skill}
                  </span>
            ...
            {preferredSkills.map((skill, index) => {
              ...
              return (
                <div key={index} className="flex items-center">
                  <div
                    className={`w-4 h-4 rounded-full mr-2 flex-shrink-0 ${
                      isMatched ? "bg-blue-500" : "bg-gray-400"
                    }`}
                  ></div>
                  <span
                    className={`text-sm ${
                      isMatched ? "text-gray-800" : "text-gray-500"
                    }`}
                  >
                    {skill}
                  </span>
        ...
        <div className="mt-6">
          ...
          <div className="p-4 bg-yellow-50 rounded-lg">
            <p className="text-sm text-yellow-800 mb-2">
              <strong>Missing Required Skills:</strong> This candidate is
              missing {missingRequiredSkills.length} required skills.
            </p>
